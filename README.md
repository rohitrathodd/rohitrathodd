...
.button-secondary {
  ...
  transition: background-color 300ms ease, color 300ms ease,
    transform 300ms ease, -webkit-transform 300ms ease;
  color: #4e4b66;
  font-size: 18px;
  font-weight: 700;
  text-align: center;
...
.back-to-top {
  ...
  bottom: 15px;
  z-index: 996;
  background: linear-gradient(10deg, #14142b 50%, #777990 100%);
  width: 40px;
  height: 40px;
  border-radius: 50px;
  transition: all 0.4s;
...
.back-to-top:hover {
  background: linear-gradient(10deg, #14142b 70%, #14142b 100%);
  color: #fff;
}
.back-to-top.active {
  visibility: visible;
...
@font-face {
  ...
  font-display: swap;
  src: url(../vendor/bootstrap-icons/fonts/bootstrap-icons.woff2?8bd4575acf83c7696dc7a14a966660a3)
      format("woff2"),
    url(../vendor/bootstrap-icons/fonts/bootstrap-icons.woff?8bd4575acf83c7696dc7a14a966660a3)
      format("woff");
}
        ...
        <div class="hero-wrapper">
          <div class="hello">
            <h1 class="title subtitle">
              Hey, I'm Rohit Rathod | @rohitrathodd
            </h1>
            <h3 class="title home-hero">
              Empowering Businesses through Cutting-Edge Software Development
            </h3>
            <img
              loading="lazy"
              src="./hero-underline.svg"
              loading="eager"
              alt="hero-underline svg"
              class="image hero-underline"
            />
            <div class="_2-column-grid">
              <div>
                <a href="https://www.rohitr.com/contact/" class="button-secondary w-button"
                  >Contact</a
                >
              </div>
              <div>
                <a href="https://www.rohitr.com/rohitrathod/" class="button-primary w-button"
                  >About</a
                >
              </div>
            </div>
          ...
          <div
            data-w-id="62baa06f-5c49-4902-dcc5-46ded3bffd2d"
            class="image-wrapper hero-image"
          >
            <img
              src="https://i.pinimg.com/736x/05/ee/6e/05ee6e32e4c72775c66b5c9a1d352778.jpg"
              alt="Rohit Rathod"
